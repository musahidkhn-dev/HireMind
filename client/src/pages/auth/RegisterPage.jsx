...
import { Brain, Building2, Mail, Lock, User as UserIcon } from 'lucide-react';
...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2 bg-transparent">
      ...
      <div className="flex items-center justify-center px-6 md:px-12 lg:px-20 py-10 z-10 overflow-y-auto">
        <div className="w-full max-w-md py-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div className="grid grid-cols-2 gap-3 p-1 bg-gray-100 dark:bg-white/5 rounded-2xl border border-border dark:border-slate-700">
            ...
            <div className="pt-2">
              <label className="flex items-start gap-3 cursor-pointer group">
                <input type="checkbox" {...register('terms')} className="w-5 h-5 mt-0.5 rounded-lg border-border dark:border-slate-600 text-primary focus:ring-primary/20" />
          ...
          <div className="mt-8 relative">
            ...
            <div className="relative flex justify-center text-[10px] font-black uppercase tracking-widest"><span className="bg-white dark:bg-slate-900 px-4 text-text-secondary transition-colors">Or continue with</span></div>
          </div>

          <div className="mt-6 grid grid-cols-1 gap-4">
            <button 
              onClick={() => window.location.href = "/api/auth/google"}
              className="flex items-center justify-center gap-3 py-3 rounded-xl border border-border dark:border-slate-700 hover:bg-gray-50 dark:hover:bg-white/5 transition-all font-bold text-xs dark:text-white"
            >
      ...
      <div className="hidden md:flex items-center justify-center bg-gray-50 dark:bg-slate-900 p-12 overflow-hidden relative transition-colors">
        ...
        >
          <div className="relative group">
            <img 
              ...
              className="w-full h-auto drop-shadow-2xl rounded-3xl mb-12 group-hover:scale-105 transition-transform duration-700" 
              loading="eager"
            />
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/50 z-20 rounded-3xl pointer-events-none mix-blend-multiply" />
          </div>
