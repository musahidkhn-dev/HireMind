...
const ChartCard = ({ title, data = [], type = 'bar' }) => {
  ...
  return (
    <div className="card p-6 bg-white dark:bg-gray-900 h-full">
      <h3 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-widest mb-8 border-l-4 border-amber-600 pl-3">
        {title}
      </h3>
          ...
          return (
            <div key={idx} className="flex-1 flex flex-col items-center gap-3 group h-full justify-end">
              <div className="relative w-full flex justify-center items-end h-full">
                ...
                <div 
                  className={twMerge(
                    "w-full max-w-[40px] rounded-t-lg transition-all duration-500 bg-amber-100 dark:bg-amber-900 group-hover:bg-amber-600 group-hover:shadow-lg group-hover:shadow-amber-200 dark:group-hover:shadow-none",
